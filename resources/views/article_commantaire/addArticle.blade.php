    ...
    <div class="max-w-3xl mx-auto mt-8 p-6 bg-white rounded shadow">
        ...
        <form action="{{ route('storeArticle') }}" method="POST">
            ...
            <div class="mb-4">
               ...
               <input class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" type="text" name="title" id="">
                @error('title')
            ...
            <div class="mb-4">
                ...
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('contenu') }}</textarea>
                @error('contenu')
                <div class="text-red">{{$message}}</div>
                @enderror
            </div>
